...
if(isset($_POST['egresar'])){
	...
	if($cantidad == "" || !is_numeric($cantidad)){
		echo '{"message":"Las unidades a egresar del producto está vacío o no es válido.","message_type":"warning"}';
		header("refresh:2;url=index.php");
	}else if($cantidad > $mostrar['cantidad']){
		echo '{"message":"Las unidades a egresar del producto superan su stock disponible.","message_type":"warning"}';
